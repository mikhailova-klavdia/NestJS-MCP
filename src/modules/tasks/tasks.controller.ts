...
export class TasksController {
  ...
  @Post()
  async createTask(@Body() createTaskDto: { title: string; description: string }): Promise<Task> {
    return await this.tasksService.createTask(createTaskDto.title, createTaskDto.description);
  }
